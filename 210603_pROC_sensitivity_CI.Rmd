...
##th, se, sp bootstrap
(cha60_ci_np <- ci.coords(roc(df_proc_np$eGFR_ab, df_proc_np$prob), x="best", ret=c("threshold", "sensitivity", "specificity"), boot.n = 10000))
...
##auc bootstrap
print("60 proteinuria auc"); ci.auc(df_proc_p$eGFR_ab, df_proc_p$prob, method="bootstrap", boot.n=30)
...
##th, se, sp bootstrap
(cha60_p <- ci.coords(roc(df_proc_p$eGFR_ab, df_proc_p$prob), x="best", ret=c("threshold", "sensitivity", "specificity"), boot.n = 10000))
```
...
##auc bootstrap
print("45 non-proteinuria auc"); ci.auc(df_proc_np45$eGFR_ab45, df_proc_np45$prob, method="bootstrap")
...
##th, se, sp, bootstrap
(cha45_ci_np <- ci.coords(roc(df_proc_np45$eGFR_ab45, df_proc_np45$prob), x="best", ret=c("threshold", "sensitivity", "specificity"), boot.n = 10000))
...
##auc bootstrap
print("45 proteinuria auc"); ci.auc(df_proc_p45$eGFR_ab45, df_proc_p45$prob, method="bootstrap")
...
##th, se, sp, bootstrap
(cha45_ci_p <- ci.coords(roc(df_proc_p45$eGFR_ab45, df_proc_p45$prob), x="best", ret=c("threshold", "sensitivity", "specificity"), boot.n=10000, boot.stratified = T))
```
